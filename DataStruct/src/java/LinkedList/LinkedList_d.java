...
/**
 * @className LinkedList_d
 * @Author lulu
 * @Date 2019/12/3 11:31 下午
 * 单链表的增删改查方法的递归实现(借鉴https://www.cnblogs.com/zy-2113/p/10781280.html)
 **/
public class LinkedList_d<E extends Comparable<E>> {
    ...
    public static void main(String[] args) {
        LinkedList_d<Integer> ll = new LinkedList_d<>();
        for (int i = 0; i < 13; i++) {
            ll.addLast(i);
